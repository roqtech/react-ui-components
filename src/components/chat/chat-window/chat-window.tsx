...
const _CLASS_IS = COMPONENT_CLASS_PREFIX + "chat-window";
...
const ChatWindow = (props: ChatWindowPropsInterface) => {
...
export default withChatState<ChatWindowPropsInterface, "conversationId">(
